...
trainer_stats_name="forward_timer"
...
class NOOPTrainerStats(base.TrainerStats):
    ...
    def start_process_batch(self) -> None: pass
    def stop_process_batch(self) -> None: pass
    ...
    def stop_forward(self) -> None:
        ...
        elapsed = self._start_event.elapsed_time(self._end_event) / 1000.0  # ms → s
